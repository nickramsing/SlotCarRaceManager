# 1: PROBLEM
Experienced challenges trying to mathmatically solve the optimization problem.

# 2: SOLUTION VISION
Leverave Claude Code with prompts and CLAUDE.md to solve for the various parameters: cars, drivers, etc.

# 3: TECHNICAL APPROACH WITH CLAUDE CODE
